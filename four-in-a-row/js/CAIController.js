function CAIController(){
	...
	this.verifyIfPlayerWinsWithDiagonalDxLine = function( iRow, iCol,iCodePlayer, iThreshold,oObjAdjacency ){
		var iCntCoins = 0, iOffset = 1, iFreeAdjacency = 0;		
	...
	this.verifyIfPlayerWins = function( iRow, iCol, iCodePlayer, iThreshold ){
                var oObjAdjacency = {};
		if ( this.verifyIfPlayerWinsWithDiagonalDxLine( iRow, iCol, iCodePlayer, iThreshold,oObjAdjacency ) ){ return true; }
		if ( this.verifyIfPlayerWinsWithDiagonalSxLine( iRow, iCol, iCodePlayer, iThreshold,oObjAdjacency ) ){ return true; }
		if ( this.verifyIfPlayerWinsWithVerticalLine  ( iRow, iCol, iCodePlayer, iThreshold,oObjAdjacency ) ){ return true; }		
		if ( this.verifyIfPlayerWinsWithHorizontalLine( iRow, iCol, iCodePlayer, iThreshold,oObjAdjacency ) ){ return true; }		
		return false;
	};
	...
	this.analyseArrayCols = function( aCols ){
		...
		*/
		...
		for ( i = 0; i < aCols.length; i++ ){
                    ...
                    if ( bFound === false ){
                        aRetList.push( new Object( { iValue:aCols[i], iCnt:1 } ) );
                    }
		}
