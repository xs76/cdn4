...
const scriptsInEvents = {
	...
	async Ev_poki_Event4_Act1(runtime, localVars)
	{
		PokiSDK.rewardedBreak('cosmetic',localVars.details,'gameplay').then(
		        (success) => {
		    if(success) {
				runtime.callFunction("rewardVideoSuccess")
		        
		    } else {
				runtime.callFunction("rewardVideoFail")
	...
	async Evloading_Event5_Act1(runtime, localVars)
	{
